...
export const Header = ({ onExportPDF, lastUpdate }) => {
      ...
      <div className="max-w-7xl mx-auto flex justify-between items-center">
        ...
        <div className="flex items-center gap-6">
          ...
          <select
            ...
            className="bg-[#242d4a] border border-[#3a4458] text-[#f5f7fa] px-3 py-1 rounded text-sm hover:border-[#00d4aa] transition"
          >
